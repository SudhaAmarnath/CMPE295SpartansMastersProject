 ...
 */
public class PostedItemAdapter extends RecyclerView.Adapter<PostedItemAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Item> items;
    private ClickListenerItem itemClickListener;

    public PostedItemAdapter(ArrayList<Item> items, Context context, ClickListenerItem itemClickListener) {
